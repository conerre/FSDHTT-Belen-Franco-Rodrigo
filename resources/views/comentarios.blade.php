...
<div class="container">
	<div class="row">
		<h2>Comentarios |2| <div class="pull-right"><a href="#" id="addacomment" class="btn btn-primary">Agregar comentario</a> </div></h2>
	</div>
	...
	<div class="row comment">
	    <div class="head">
	        <small><strong class='user'>Juan25</strong> 30.10.2017 12:13</small>
	    </div>    
	...
	<div class="row comment">
	    <div class="head">
	        <small><strong class='user'>MariaLuz</strong> 30.10.2017 12:13</small>
	    </div>    
